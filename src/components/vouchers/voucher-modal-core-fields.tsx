      ...
      <div className="flex flex-col gap-3 p-4 bg-muted/40 border border-border rounded-lg">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className={fieldContainerClass}>
            ...
            <Input type="date" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("date")} />
      ...
      <div className="flex flex-col gap-3 p-4 bg-muted/40 border border-border rounded-lg">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className={cn(fieldContainerClass, "col-span-1")}>
            ...
            <Input placeholder="00001" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("posNumber")} onBlur={handlePosBlur} />
            {errors.posNumber && <p className={errorClass}>{errors.posNumber.message}</p>}
          </div>

          <div className={cn(fieldContainerClass, "col-span-2")}>
            <label className={labelClass}>Número</label>
            <Input placeholder="00000000" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("number")} onBlur={handleNumberBlur} />
      ...
      <div className="flex flex-col gap-3 p-4 bg-muted/40 border border-border rounded-lg">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className={fieldContainerClass}>
            ...
            <Input type="number" step="0.01" placeholder="0.00" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("subtotal", { valueAsNumber: true })} />
            {errors.subtotal && <p className={errorClass}>{errors.subtotal.message}</p>}
          </div>
          <div className={fieldContainerClass}>
            <label className={labelClass}>IVA</label>
            <Input type="number" step="0.01" placeholder="0.00" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("vatAmount", { valueAsNumber: true })} />
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className={fieldContainerClass}>
            ...
            <Input type="number" step="0.01" placeholder="0.00" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("nonTaxableAmount", { valueAsNumber: true })} />
            {errors.nonTaxableAmount && <p className={errorClass}>{errors.nonTaxableAmount.message}</p>}
          </div>
          <div className={fieldContainerClass}>
            <label className={labelClass}>Exento</label>
            <Input type="number" step="0.01" placeholder="0.00" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("exemptAmount", { valueAsNumber: true })} />
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className={fieldContainerClass}>
            ...
            <Input placeholder="Transferencia" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("paymentMethod")} />
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className={fieldContainerClass}>
            ...
            <Input type="date" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("paymentDate")} />
            {errors.paymentDate && <p className={errorClass}>{errors.paymentDate.message}</p>}
          </div>
          <div className={fieldContainerClass}>
            <label className={labelClass}>Importe Pagado</label>
            <Input type="number" step="0.01" placeholder="0.00" className="bg-card h-[38px] text-[13px] px-3" disabled={isProcessing} {...register("paidAmount", { valueAsNumber: true })} />
