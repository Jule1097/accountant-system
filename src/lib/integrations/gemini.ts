...
function buildSharedPromptParts(options: GeminiParseOptions): string[] {
  const promptParts = [
    ...
    "If the document is an electronic MiPyME credit invoice, prefer the exact voucherType label 'Factura de Crédito Electrónica MiPyME (FCE)' when that wording is visible.",
